...
// $Rev: 17244 $
// File generated on 16/04/2010 3:43:29 PM from Type Library described below.
...
// *********************************************************************//
  ISAXXMLReader = interface(IUnknown)
    ...
    function getBaseURL: PWord1; safecall;
    procedure putBaseURL(var pwchBaseUrl: Word); safecall;
    function getSecureBaseURL: PWord1; safecall;
...
// *********************************************************************//
  ISAXEntityResolver = interface(IUnknown)
    ...
    function resolveEntity(var pwchPublicId: Word; var pwchSystemId: Word): OleVariant; safecall;
  end;
...
// *********************************************************************//
  ISAXContentHandler = interface(IUnknown)
    ...
    procedure startPrefixMapping(var pwchPrefix: Word; cchPrefix: SYSINT; var pwchUri: Word;
                                 cchUri: SYSINT); safecall;
    procedure endPrefixMapping(var pwchPrefix: Word; cchPrefix: SYSINT); safecall;
    procedure startElement(var pwchNamespaceUri: Word; cchNamespaceUri: SYSINT;
                           var pwchtagName: Word; cchtagName: SYSINT; var pwchQName: Word;
                           cchQName: SYSINT; const pAttributes: ISAXAttributes); safecall;
    procedure endElement(var pwchNamespaceUri: Word; cchNamespaceUri: SYSINT;
                         var pwchtagName: Word; cchtagName: SYSINT; var pwchQName: Word;
                         cchQName: SYSINT); safecall;
    ...
    procedure processingInstruction(var pwchTarget: Word; cchTarget: SYSINT; var pwchData: Word;
                                    cchData: SYSINT); safecall;
...
// *********************************************************************//
  ISAXLocator = interface(IUnknown)
    ...
    function getPublicId: PWord1; safecall;
    function getSystemId: PWord1; safecall;
  end;
...
// *********************************************************************//
  ISAXAttributes = interface(IUnknown)
    ...
    procedure getURI(nIndex: SYSINT; out ppwchUri: PWord1; out pcchUri: SYSINT); safecall;
    procedure gettagName(nIndex: SYSINT; out ppwchtagName: PWord1; out pcchtagName: SYSINT); safecall;
    procedure getQName(nIndex: SYSINT; out ppwchQName: PWord1; out pcchQName: SYSINT); safecall;
    procedure getName(nIndex: SYSINT; out ppwchUri: PWord1; out pcchUri: SYSINT;
                      out ppwchtagName: PWord1; out pcchtagName: SYSINT;
                      out ppwchQName: PWord1; out pcchQName: SYSINT); safecall;
    function getIndexFromName(var pwchUri: Word; cchUri: SYSINT; var pwchtagName: Word;
                              cchtagName: SYSINT): SYSINT; safecall;
    function getIndexFromQName(var pwchQName: Word; cchQName: SYSINT): SYSINT; safecall;
    procedure getType(nIndex: SYSINT; out ppwchType: PWord1; out pcchType: SYSINT); safecall;
    procedure getTypeFromName(var pwchUri: Word; cchUri: SYSINT; var pwchtagName: Word;
                              cchtagName: SYSINT; out ppwchType: PWord1; out pcchType: SYSINT); safecall;
    procedure getTypeFromQName(var pwchQName: Word; cchQName: SYSINT; out ppwchType: PWord1;
                               out pcchType: SYSINT); safecall;
    procedure getValue(nIndex: SYSINT; out ppwchValue: PWord1; out pcchValue: SYSINT); safecall;
    procedure getValueFromName(var pwchUri: Word; cchUri: SYSINT; var pwchtagName: Word;
                               cchtagName: SYSINT; out ppwchValue: PWord1; out pcchValue: SYSINT); safecall;
    procedure getValueFromQName(var pwchQName: Word; cchQName: SYSINT; out ppwchValue: PWord1;
...
// *********************************************************************//
  ISAXDTDHandler = interface(IUnknown)
    ...
    procedure notationDecl(var pwchName: Word; cchName: SYSINT; var pwchPublicId: Word;
                           cchPublicId: SYSINT; var pwchSystemId: Word; cchSystemId: SYSINT); safecall;
    procedure unparsedEntityDecl(var pwchName: Word; cchName: SYSINT; var pwchPublicId: Word;
                                 cchPublicId: SYSINT; var pwchSystemId: Word; cchSystemId: SYSINT;
                                 var pwchNotationName: Word; cchNotationName: SYSINT); safecall;
  end;
...
// *********************************************************************//
  ISAXErrorHandler = interface(IUnknown)
    ...
    procedure fatalError(const pLocator: ISAXLocator; var pwchErrorMessage: Word;
                         hrErrorCode: HResult); safecall;
    procedure ignorableWarning(const pLocator: ISAXLocator; var pwchErrorMessage: Word;
                               hrErrorCode: HResult); safecall;
  end;
...
// *********************************************************************//
  ISAXLexicalHandler = interface(IUnknown)
    ...
    procedure startDTD(var pwchName: Word; cchName: SYSINT; var pwchPublicId: Word;
                       cchPublicId: SYSINT; var pwchSystemId: Word; cchSystemId: SYSINT); safecall;
...
// *********************************************************************//
  ISAXDeclHandler = interface(IUnknown)
    ...
    procedure attributeDecl(var pwchElementName: Word; cchElementName: SYSINT;
                            var pwchAttributeName: Word; cchAttributeName: SYSINT;
                            var pwchType: Word; cchType: SYSINT; var pwchValueDefault: Word;
                            cchValueDefault: SYSINT; var pwchValue: Word; cchValue: SYSINT); safecall;
    procedure internalEntityDecl(var pwchName: Word; cchName: SYSINT; var pwchValue: Word;
                                 cchValue: SYSINT); safecall;
    procedure externalEntityDecl(var pwchName: Word; cchName: SYSINT; var pwchPublicId: Word;
                                 cchPublicId: SYSINT; var pwchSystemId: Word; cchSystemId: SYSINT); safecall;
  end;
...
// *********************************************************************//
  IVBSAXContentHandler = interface(IDispatch)
    ...
    procedure startElement(var strNamespaceURI: WideString; var strtagName: WideString;
                           var strQName: WideString; const oAttributes: IVBSAXAttributes); safecall;
    procedure endElement(var strNamespaceURI: WideString; var strtagName: WideString;
...
// *********************************************************************//
  IVBSAXAttributes = interface(IDispatch)
    ...
    function gettagName(nIndex: SYSINT): WideString; safecall;
    function getQName(nIndex: SYSINT): WideString; safecall;
    function getIndexFromName(const strURI: WideString; const strtagName: WideString): SYSINT; safecall;
    function getIndexFromQName(const strQName: WideString): SYSINT; safecall;
    function getType(nIndex: SYSINT): WideString; safecall;
    function getTypeFromName(const strURI: WideString; const strtagName: WideString): WideString; safecall;
    ...
    function getValueFromName(const strURI: WideString; const strtagName: WideString): WideString; safecall;
...
// *********************************************************************//
  IVBSAXAttributesDisp = dispinterface
    ...
    function gettagName(nIndex: SYSINT): WideString; dispid 1346;
    function getQName(nIndex: SYSINT): WideString; dispid 1347;
    function getIndexFromName(const strURI: WideString; const strtagName: WideString): SYSINT; dispid 1348;
    ...
    function getTypeFromName(const strURI: WideString; const strtagName: WideString): WideString; dispid 1351;
    ...
    function getValueFromName(const strURI: WideString; const strtagName: WideString): WideString; dispid 1354;
...
// *********************************************************************//
  IMXAttributes = interface(IDispatch)
    ...
    procedure addAttribute(const strURI: WideString; const strtagName: WideString;
    ...
    procedure setAttribute(nIndex: SYSINT; const strURI: WideString;
                           const strtagName: WideString; const strQName: WideString;
                           const strType: WideString; const strValue: WideString); safecall;
    procedure setAttributes(varAtts: OleVariant); safecall;
    procedure settagName(nIndex: SYSINT; const strtagName: WideString); safecall;
...
// *********************************************************************//
  IMXAttributesDisp = dispinterface
    ...
    procedure settagName(nIndex: SYSINT; const strtagName: WideString); dispid 1378;
...
// *********************************************************************//
  IMXNamespaceManager = interface(IUnknown)
    ...
    procedure pushNodeContext(const contextNode: IXMLDOMNode; fDeep: WordBool); safecall;
    procedure popContext; safecall;
    procedure declarePrefix(var prefix: Word; var namespaceURI: Word); safecall;
    procedure getDeclaredPrefix(nIndex: Integer; var pwchPrefix: Word; var pcchPrefix: SYSINT); safecall;
    procedure getPrefix(var pwszNamespaceURI: Word; nIndex: Integer; var pwchPrefix: Word;
                        var pcchPrefix: SYSINT); safecall;
    procedure getURI(var pwchPrefix: Word; const pContextNode: IXMLDOMNode; var pwchUri: Word;
                     var pcchUri: SYSINT); safecall;
  end;
